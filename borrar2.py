...
cv2.putText(background,
            "Seleccione las cuatro esquinas de la mesa !",
            (50, 50),
...
background=get_frame()
cv2.putText(background,
            "Vuelva a colocar los circulos en las cuatro esquinas!",
            (50, 50),
            cv2.FONT_HERSHEY_SIMPLEX,
            1/2,
            (0,0,255),
...
cv2.putText(calibration_test2,
            "Imagen 2D para deformar en un espacio 3D para que quepa en la mesa de billar, presione una tecla para continuar",
            (50, 50),
            cv2.FONT_HERSHEY_SIMPLEX,
            1/2,
            (0,0,255),
...
cv2.putText(test_1,
            "Imagen 2D distorsionada en el espacio 3D, presione cualquier tecla para continuar",
            (50, 50),
            cv2.FONT_HERSHEY_SIMPLEX,
            1/2,
            (0,0,255),
...
cv2.putText(test_2,
            "Imagen 3D de la mesa de billar distorsionada para moverse al espacio 2D de la pantalla, presione cualquier tecla para continuar",
            (50, 50),
            cv2.FONT_HERSHEY_SIMPLEX,
            1/2,
            (0,0,255),
